...
<c:import url="../layout/app.jsp">
    ...
    <c:param name="content">
        ...
        <form method="POST"
            ...
            <label>年齢<br /> <input type="text" name="age" value="0" /></label> <br /> <label>性別<br />
                <select name="sex" size="1">
                    <option value="1" label="男" selected>男</option>
                    <option value="2" label="女">女</option>
            </select></label> <br /> <label>身長<br /> <input type="text" name="height" value="0"/></label>
            <br /> <label>体重<br /> <input type="text" name="weight" value="0"/></label>
            <br /> <label>体脂肪<br /> <input type="text" name="bodyFat" value="0"/></label><br />
            <label>目標体重<br /> <input type="text" name="targetWeight"value="0" /></label><br />
            ...
            <br /> <label>目標PFC割合<br /> P: <input type="text"
                name="targetProtein"value="0" />F: <input type="text" name="targetFat"value="0" />C:
                <input type="text" name="targetCarbo" value="0" /></label> <br /> <label>パスワード<br />

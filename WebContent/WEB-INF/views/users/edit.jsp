...
selected
                    ...
                    type="text" name="weight" value="${login_user.weight}" /></label> <br />
                <label>体脂肪<br /> <input type="text" name="bodyFat"
                    value="${login_user.bodyFat}" /></label><br /> <label>目標体重<br />
...
selected
                    ...
                    name="targetFat" value="${login_user.targetFat}" />C: <input
                    type="text" name="targetCarbo" value="${login_user.targetCarbo}" /></label>
                <br /> <input type="hidden" name="id" value="${login_user.id}" />
                <input type="hidden" name="password" value="${login_user.password}" />
                <button type="submit">登録</button>
            </form>
            <br /> <a href="<c:url value='?action=User&command=show' />">戻る</a>

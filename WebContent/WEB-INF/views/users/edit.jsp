    ...
    <c:param name="content">
        ...
        <form method="POST"
            ...
            <label>氏名<br /> <input type="text" name="name"
                ...
                type="text" name="age" value="${login_user.age}" size="3" /></label> <br />
            <label>性別<br /> <select name="sex" size="1">
...
selected
                ...
                value="${login_user.height}" size="5" /></label> <br /> <label>体重<br />
                <input type="text" name="weight" value="${login_user.weight}"
                size="5" /></label> <br /> <label>体脂肪<br /> <input type="text"
                name="bodyFat" value="${login_user.bodyFat}" size="5" /></label><br /> <label>目標体重<br />
                <input type="text" name="targetWeight"
                value="${login_user.targetWeight}" size="5" /></label><br /> <label>活動レベル<br />
...
selected
                ...
                value="${login_user.targetProtein}" size="5" />&nbsp;F: <input
                type="text" name="targetFat" value="${login_user.targetFat}"
                size="5" />&nbsp;C: <input type="text" name="targetCarbo"
                value="${login_user.targetCarbo}" size="5" /></label> <br /> <input
                type="hidden" name="id" value="${login_user.id}" /> <input
                type="hidden" name="password" value="${login_user.password}" /><br />
